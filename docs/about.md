...
- **MCP server** ([aap-agent-bounty-skill](https://github.com/AlphaC007/aap-agent-bounty-skill)): 5 read-only tools for thesis, scenario, CIO report, market data, and claim guide access
...
- [Earn AAP →](https://alphac007.github.io/trump3fight/agent-reward/)
...
| Repo | Purpose |
| --- | --- |
| [trump3fight](https://github.com/AlphaC007/trump3fight) | Research framework, CIO reports, trend data, public methodology |
| [aap-agent-bounty-skill](https://github.com/AlphaC007/aap-agent-bounty-skill) | MCP server for AI agent data access |
